...
void RunAction::BeginOfRunAction(const G4Run*)
{
    ...
    sprintf(file_name, "/media/lsh/CosmicrayRnE/simulationData/real-simulation/csv/%04dY%02dM%02dD%02dh%02dm%02ds_e-10MeV%d", date->tm_year + 1900, date->tm_mon+1, date->tm_mday, date->tm_hour, date->tm_min, date->tm_sec, rand());
