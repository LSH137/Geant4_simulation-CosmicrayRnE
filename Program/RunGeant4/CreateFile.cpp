...
void MakeFile(int number_of_proj)
{
    ...
    for(int i = 1; i <= number_of_proj; i++)
    {
        ...
        sprintf(dir, "%s/mu-/%fGeV/src/PrimaryGeneratorAction.cc",ProjectDir, energy);
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        sprintf(dir, "%s/mu-/%fGeV/src/RunAction.cc",ProjectDir, energy);
        ...
        RunAction<<"#include \"RunAction.hh\"\n"
                   ...
                   "    srand((int)time(0));\n"
                   "\n"
                   "    sprintf(file_name, \"/media/cosmicray/CosmicrayRnE/%04dY%02dM%02dD%02dh%02dm%02ds_"<<particle<<(int)(energy*1000)<<"MeV%d.csv\", date->tm_year + 1900, date->tm_mon+1, date->tm_mday, date->tm_hour, date->tm_min, date->tm_sec, rand());\n"
                   "\n"
    ...
    {
        energy = (double)i / divide;
        sprintf(dir, "%s/e-/%fGeV/src/PrimaryGeneratorAction.cc",ProjectDir, energy);
        std::ofstream PrimaryGeneratorAction(dir);
        ...
        PrimaryGeneratorAction.close();
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        sprintf(dir, "%s/e-/%fGeV/src/RunAction.cc",ProjectDir, energy);
        std::ofstream RunAction(dir);
